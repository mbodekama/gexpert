        ...
        <div class="inner-banner inner-bg7">
            <div class="container">
                <div class="inner-title">
                    <h3>Vente de fournitures de bureau</h3>
                    <ul>
                        <li>
        ...
        <section class="product-area pt-100 pb-70">
            <div class="container">
                <div class="section-title text-center">
                    <span>Produits de bureau</span>
                    <h2>Nos meilleurs produits a votre disposition</h2>
                    <p>
              ...
              include 'connexion.php';
                ...
                $requete =$bdd->prepare('SELECT * FROM produits WHERE categorie=2 LIMIT 21');
                $requete->execute();
